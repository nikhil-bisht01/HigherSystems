...
const AddressSection = () => {
  return (
    <section style={{fontFamily:"Inter , sans-serif"}} className='px-36 text-lg font-semibold py-36'>
      ...
      <div className='grid grid-cols-3 gap-16'>
          ...
          <div className=' border-[1px] p-5 rounded-md border-gray-300'>
            <h1 className='font-medium text-lg'>213, Block A4, Savitri Heights 2, VIP Road, 
            Zirakpur, Punjab</h1>
          </div>
          <div className=' border-[1px] p-5 rounded-md border-gray-300'>
            <h1 className='font-medium text-lg'>Mohd. Johar 
                Ali Road, Rampur,
                Uttar Pradesh - 244901</h1>
          </div>
      </div>
    </section>
  )
