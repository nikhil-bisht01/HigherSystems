  ...
  return (
    <form className="w-full" onSubmit={handleSubmit} noValidate>
      <div className="w-full flex flex-col md:flex-row justify-between mb-6">
        <div className="w-full md:w-[47%] mb-4 md:mb-0">
          <input
            type="text"
            name="firstName"
            value={formData.firstName}
            onChange={handleChange}
            className={`w-full p-3 border-[2px] rounded-md font-medium text-sm focus:border-blue-600 focus:outline-none ${errors.firstName ? 'border-red-500' : ''}`}
        ...
        <div className="w-full md:w-[47%]">
          <input
            ...
            onChange={handleChange}
            className={`w-full p-3 border-[2px] rounded-md font-medium text-sm focus:border-blue-600 focus:outline-none ${errors.lastName ? 'border-red-500' : ''}`}
      ...
      <div className="mb-6">
        <input
          ...
          onChange={handleChange}
          className={`w-full p-3 border-[2px] rounded-md font-medium text-sm focus:border-blue-600 focus:outline-none ${errors.email ? 'border-red-500' : ''}`}
      ...
      <div className="mb-6">
        <input
          ...
          onChange={handleChange}
          className={`w-full p-3 border-[2px] rounded-md font-medium text-sm focus:border-blue-600 focus:outline-none ${errors.phone ? 'border-red-500' : ''}`}
      ...
      <div className="mb-5">
        <textarea
          ...
          onChange={handleChange}
          className={`w-full border-[2px] mb-5 p-3 rounded-md focus:border-blue-600 focus:outline-none ${errors.message ? 'border-red-500' : ''}`}
          cols={10}
          rows={4}
          placeholder="Message"
        ></textarea>
