...
export const coreComponents = [
  {
    title: 'Product Innovation and Technical Excellence',
    description:
      'At Higher India, we lead the way in creating innovative software products that transform businesses. By leveraging advanced technologies and agile development methodologies, we deliver scalable, adaptable, and future-proof solutions. Our technical expertise ensures rapid and iterative development, enabling businesses to stay ahead in dynamic markets while maintaining a competitive edge.',
  },
  {
    title: 'Comprehensive IT Solutions with Industry-Specific Expertise',
    description:
      'As a trusted IT solutions provider, Higher India combines deep industry knowledge with cutting-edge technology to craft bespoke solutions that address unique business challenges. Our expertise spans diverse industries, allowing us to design impactful, targeted IT strategies and software products that deliver measurable value and drive operational success.',
  },
  {
    title: 'Quality Assurance and Client-Focused Support',
    description:
      'Quality and client satisfaction are the cornerstones of our approach. Our rigorous testing protocols and adherence to industry best practices ensure the reliability and performance of our solutions. Backed by a customer-centric support model, we actively align our products and services with client feedback and evolving market needs, fostering long-term partnerships and delivering sustainable value.',
  },
];
...
export const implementationAndSupportServices = [
  {
